    ...
    dependencies = {
      ...
      },
      {
        ...
        config = function()
          ...
          dapui.setup()
          vim.keymap.set('n', '<leader>dapui', function()
            dapui.toggle()
...
-- Block cursor
vim.api.nvim_command 'augroup myCursorShape'
vim.api.nvim_command 'autocmd!'
vim.api.nvim_command 'autocmd VimEnter,InsertEnter * set guicursor=a:block'
vim.api.nvim_command 'autocmd InsertLeave * set guicursor='
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>ca', function()
    vim.lsp.buf.code_action { apply = true, context = { only = { 'quickfix', 'refactor', 'source' } } }
  end, '[C]ode [A]ction')
...
local NoNeckPain = function()
  vim.cmd 'NoNeckPain'
  vim.cmd [[autocmd VimEnter * lua vim.cmd('wincmd l')]]
end
